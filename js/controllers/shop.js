...
myApp.controller('productList', function ($scope) {
    ...
    $scope.products = [
        ...
        {'productClassName': 'Сироп', 'productName': 'Кавун', 'src': 'images/shop/syrop/Фруктово-ягідна група/Кавун.jpg','group': 'fruit-berry', 'price': '50₴',
            'description': 'Сироп "Кавун" має насичений білі-червоний колір. ТМ Nelli "Кавун" відрізняється незрівнянно свіжим і солодким смаком. Цей сироп якнайкраще підійде для створення освіжаючого лимонаду. Сироп чудово підходить для коктейлів з рому і мартіні.'},
